...
*/
 ...
 $ACCESS_PWD='2wsx3edc'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 #"totoxcom_user01","2wsx1qaz"
 $DBDEF=array(
 'user'=>"totoxcom_user01",#required
 'pwd'=>"2wsx1qaz", #required
 'db'=>"totoxcom_XPTELE",  #optional, default DB
 'host'=>"",#optional
 'port'=>"",#optional

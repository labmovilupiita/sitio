...
$cons = mysql_query("select b.nombre, b.apellidos, b.email from (select * from asistencia where ponencia = 12) as a join (select * from auditorio) as b on a.usuario = b.id_usuario");

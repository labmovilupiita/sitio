...
$publis = $pubdao->selectPublicacionesPage(20, $page);
        ...
        <div class="card z-depth-2">
            <div class="card-content">
                ...
                <div class="row center mb-0">
                    <div class="col m6 s6">
                        <a class="waves-effect waves-teal btn-flat w100">Ver</a>
                    </div>
                    <div class="col m6 s6">
                        <a class="waves-effect waves-teal btn-flat w100">Ver en Mapa</a>
                    </div>

...
<head>
	...
	<script>
		...
		function showAlumno()
			...
			xmlhttp.open("GET","ttFunctionGet.php?optionsRadios="+ value +"&str="+str+"&proceso=2",true);
			xmlhttp.send();
		}
	</script>
</head>
			...
			<div class="pure-g">
			    <div class="pure-u-1">
					<form class="pure-form" method="get" action="ttFunctionGet.php">
					    ...
					    <label for="option-three" class="pure-radio" style="display: inline-block;">
					        <input id="option-three" type="radio" name="optionsRadios" value="3" onclick="setValue(3);">
					        TT
					    </label>
			    		<input type="text" name="str" id="str" class="pure-input-rounded" style="width: 300px;display: inline-block;">
			    		<button type="button" class="pure-button" onclick="showAlumno();">Buscar</button>

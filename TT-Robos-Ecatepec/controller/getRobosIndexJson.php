...
$ubicaciones = $udao->selectIdUbicacionesUbicadas(10);
$reportesJson = array();
...
foreach ($ubicaciones as $ubicacion) {
    ...
    $reporteJson = array("idreporte" => $reporte->getIdReporteRobo(), "fecha" => $reporte->getFechaCreacion(), "detalle" => $reporte->getDetalle(), "lematizado" => $reporte->getLematizado(), "ubicacion" => $ubicacionJson, "publicacion" => $publicacionJson, "clase" => array());

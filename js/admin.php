...
$cons = mysql_query("SELECT id, hora, nombre, ponencia from ponentes ORDER BY hora") or die(mysql_error());
?>
...
<?php
    ...
    <tr bgcolor="#FAFAFA">
      ...
      <td valign="middle" ><p><a href="ponente.php?id=<? echo $row['id']?>"><? echo $row['ponencia']; ?></a></p></td>
